...
class GestureRecognizerHelper(
    ...
    private var inputImageBitmap: Bitmap? = null
    ...
    companion object {
        ...
        private const val MP_RECOGNIZER_TASK = "mediaPipe/gesture_recognizer.task"
    ...
    interface GestureRecognizerListener {
        ...
        fun onResults(resultBundle: ResultBundle, inputImage: Bitmap)
    }
