package com.example.tensorflowlitetest.utils.mediaPipe
...
class ObjectDetectorHelper(
    ...
    fun setupObjectDetector() {
        ...
        val modelName = getNameFromId("mediaPipe", currentModel)
    ...
    fun detectLivestreamFrame(imageProxy: ImageProxy) {
        ...
        val bitmapBuffer = imageProxy.toBitmap()/* Bitmap.createBitmap(
    ...
    companion object {
        ...
        const val TAG = "ObjectDetectorHelperMediaPipe"
    }
